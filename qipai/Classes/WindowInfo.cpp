...
{
    m_kUseSize.width = 750;
    m_kUseSize.height = 1334;
...
void WindowInfo::changWinSize(cocos2d::Node* pNode)
{
	...
	float scaleX = kWinSize.height / kUseSize.height;
	float scaleY = kWinSize.width / kUseSize.width;
