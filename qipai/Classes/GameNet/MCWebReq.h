...
public: //request
	...
	std::string parseResData(cocos2d::network::HttpResponse *response);
...
protected://resqunse
	void resCallBack(cocos2d::network::HttpClient* client,cocos2d::network::HttpResponse* response);

	bool parseResByJson(cocos2d::network::HttpResponse *response,rapidjson::Document &doc);
